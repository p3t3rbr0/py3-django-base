...
from apps.feincms import settings
from apps.feincms.extensions import ExtensionModelAdmin
...
#        r += '</span>'
        return mark_safe(r)
    indented_short_title.short_description = _(u'Название')
    ...
    actions_column.short_description = _(u'Перенос')
